...
namespace Shop.Web
{
    public class Startup
    {
        ...
        .AddEntityFrameworkStores<Data.DataContext>();
            ...
            services.AddScoped<Data.IProductRepository, Data.ProductRepository>(); //La inyeccion queda permanete durante la ejecución para que sea utilizada cuando sea necesaria...

            services.AddScoped<Helpers.IUserHelper, Helpers.UserHelper>();
